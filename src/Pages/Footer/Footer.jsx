            ...
            <footer class="">
                <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                    <div class="mx-auto max-w-md">
                        <strong
                            class="block text-center text-xl font-bold sm:text-3xl"
                        >
                            Want us to email you with the latest blockbuster news?
                        </strong>

                        <form class="mt-6 flex sm:flex-row">
                            <div class="relative max-w-lg">
                                ...
                                <button
                                    class="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-tertiary px-5 py-3 text-sm font-medium text-white transition hover:bg-tertiary"
                                >
                                    Subscribe
                                </button>
                            </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <ul class="mt-6 space-y-1">
                                    <li>
                                        <a
                                            class="0 transition hover:text-gray-700/75"
                                            href="/"
                                        >
                                            FAQs
                                        </a>
